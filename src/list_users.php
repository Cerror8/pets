    ...
    <table border="1" align="center" class="table table-hover">
        ...
        <?php 
            ...
            while($row = pg_fetch_assoc($result)){
                ...
                echo "<td><img src='icons/user.png' width='32'></td>";
                echo "<td> <a href='#'><img src='icons/edit.png' width='32'></a> 
                <form method='POST' onsubmit='return confirmDelete()'>
                <input type='hidden' name='user_id' value='". $row['id'] ."'>
                <button type='submit' name='delete_user' class='btn btn-danger btn-sm'><img src='icons/delete.png' width='20'></button>
                </form> 
                </td>";
                echo "</tr>";
            }
